...
import panda_gym
import sys
sys.path.append( "Safe_RL/safepo")
import Safe_RL.safepo.common.mpi_tools as mpi_tools
from Safe_RL.safepo.algos import REGISTRY
from Safe_RL.safepo.common.runner import Runner
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', type=str, required=True,
                        help='Choose from: {ppo, trpo, ppo_lagrangian, trpo_lagrangian, cpo, pcpo, focops, p3o, cup, sppo, lcpo}')
...
# run
#  python train_safe_rl_algorithms/train_cpo_push.py --env_id PandaPushSafe-v2 --algo cpo --cores 1 --no-mpi
