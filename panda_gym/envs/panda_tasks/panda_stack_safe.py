...
from panda_gym.envs.tasks.stack_safe import Stack
from panda_gym.pybullet import PyBullet


class PandaStackSafeEnv(RobotTaskEnv):
    ...
    def __init__(self, render: bool = False, reward_type: str = "dense", control_type: str = "ee") -> None:
        ...
        task = Stack(sim, reward_type="dense", get_ee_position=robot.get_ee_position)
